//    Question 1
// Take two numbers and take her values which should be the sum of the two numbers plus some other number.Now findout the 3rd number.
...
// let totalMarks = English + Science + Math + Hindi + SST
