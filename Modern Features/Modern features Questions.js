...
console.log(obj1.sum(arr1)); // Output: 15
...
const prices = [10.0, 20.0, 30.0, 40.0, 50.0];
...
const strings1 = ["hell", "world", "javascript", "reduce", "map", "filter"];

const totalCharacters1 = strings1
...
console.log(totalCharacters1); // 7
